...
#### &emsp;2.4.9 \$(元素名:empty)

选取既没有文本元素也没有子元素的指定元素。

#### &emsp;2.4.10 \$(元素名:parent)
...
#### &emsp;2.5.5 addClass()方法

添加类。  
`$(选择器).addClass("类名");`  
如果要添加多个，字符串中以逗号隔开。

#### &emsp;2.5.6 removeClass()方法

删除类。  
`$(选择器).removeClass("类名");`  
如果要删除多个，字符串中以逗号隔开。

#### &emsp;2.5.7 toggleClass()方法
...
##### &emsp;&emsp;2.8.4.2triggerHandle()方法
